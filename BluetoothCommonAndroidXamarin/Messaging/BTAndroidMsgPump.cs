...
namespace BluetoothCommonAndroidXamarin.Messaging {

    /// <summary>Message pump to use with Android Bluetooth Classic and LE</summary>
    public class BTAndroidMsgPump : IMsgPump<BTAndroidMsgPumpConnectData> {
        ...
        private ClassLog log = new ClassLog("BTAndroidMsgPump");
        ...
        private byte[] readBuff = new byte[READ_BUFF_SIZE];
