...
namespace MultiCommTerminal.XamarinForms.Droid.DependencyInjection {
    ...
    /// <summary>
    /// Inject a set of storage mangers. Specifically to avoid encryption
    /// which corrupts data
    /// </summary>
    public class StorageMangerSetAndroid : IStorageManagerSet {
        ...
        // Cannot use the regular encryptor for Android. Causes corruption
